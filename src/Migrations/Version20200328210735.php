 ...
 */
final class Version20200328210735 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE nom nom VARCHAR(55) NOT NULL, CHANGE prenom prenom VARCHAR(55) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE telephon telephon VARCHAR(15) NOT NULL, CHANGE adresse adresse VARCHAR(255) NOT NULL, CHANGE username username VARCHAR(155) NOT NULL');
    }
