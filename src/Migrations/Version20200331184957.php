 ...
 */
final class Version20200331184957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, role_id INT DEFAULT NULL, partenaire_id INT DEFAULT NULL, user_create_id INT DEFAULT NULL, nom VARCHAR(55) NOT NULL, prenom VARCHAR(55) NOT NULL, email VARCHAR(100) NOT NULL, telephon VARCHAR(25) NOT NULL, adresse VARCHAR(255) NOT NULL, roles JSON NOT NULL, date_naissance DATE NOT NULL, is_active TINYINT(1) NOT NULL, username VARCHAR(155) NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_8D93D649D60322AC (role_id), INDEX IDX_8D93D64998DE13AC (partenaire_id), INDEX IDX_8D93D649EEFE5067 (user_create_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE partenaire (id INT AUTO_INCREMENT NOT NULL, user_partenaire_id INT NOT NULL, ninea VARCHAR(255) NOT NULL, registre_du_commerce VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_32FFA373C678AEBE (ninea), UNIQUE INDEX UNIQ_32FFA373E484D4F5 (registre_du_commerce), INDEX IDX_32FFA3737650BEFC (user_partenaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
